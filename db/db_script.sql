/* ============================================================
   Artefacto generado y corregido con IA (script v3)
   SQL Server 2019 (RTM) 15.0.2000.5 | Base de datos: ecommercedev
   Ver prompt.md y registro_ia.md en esta misma carpeta.
   ============================================================ */
...
VALUES
    (N'Laptop Pro 15"',    N'Laptop 16GB RAM, 512GB SSD', 1299.99, 1),
